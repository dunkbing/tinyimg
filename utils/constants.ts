...
export const SITE_DESCRIPTION =
  "Compress images online quickly and easily using our free and secure tool. Perfect for JPG, PNG, and WebP formats. Try now!";
...
export const SITE_BAR_STYLES = "text-black flex justify-between px-8 py-3";
export const NAV_STYLES =
  "flex flex-wrap justify-start gap-x-4 gap-y-4 items-center justify-between h-full";
export const LINK_STYLES = "text-gray-500 transition duration-100";
